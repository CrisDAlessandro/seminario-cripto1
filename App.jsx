...
export default function App(){
  ...
  function askConfirm(title,message,onConfirm,{danger=false,label="Confirmar",showVendedor=false}={}){
    setConfirm({title,message,onConfirm,danger,label,showVendedor});
  }
